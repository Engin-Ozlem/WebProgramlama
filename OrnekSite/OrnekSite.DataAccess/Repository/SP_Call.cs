...
namespace OrnekSite.DataAccess.Repository
{
    public class SP_Call : ISP_Call
    {
        ...
        public Tuple<IEnumerable<T1>, IEnumerable<T2>> List<T1, T2>(string procedureName, DynamicParameters param = null)
        {
            ...
            {
                baglanti.Open();
                var result = SqlMapper.QueryMultiple(baglanti, procedureName, param, commandType: System.Data.CommandType.StoredProcedure);
        ...
        public T Single<T>(string procedureName, DynamicParameters param = null)
        {
            ...
            {
                baglanti.Open();
                return (T)Convert.ChangeType(baglanti.ExecuteScalar<T>(procedureName, param, commandType: System.Data.CommandType.StoredProcedure), typeof(T));
            }
        }
    }
}
